    ...
    return (
            ...
            <section class="flex flex-row w-full">
                ...
                <section class="alex flex-col w-9/12">
                    ...
                    <div class="flex content-center items-center overflow-x-auto overflow-y-auto w-[47.2%] shadow-md sm:rounded-t-xl ml-4">
                        <table class="table-auto border-collapse border border-grotto self-center">
