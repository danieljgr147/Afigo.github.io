            ...
            <>
                <tr class="even:bg-grotto odd:bg-baby" key={item.user_id}>
                    ...
                    <td class=" p-2 py-4 border-b border-mid tracking-wider text-center">
                        <div>
                            <button onClick={() => toggleDiv(itemId)}>Actualizar</button>
                ...
                <div class="w-full h-full flex flex-row">
                    {showDivMap[itemId] && <>  <EditarUsuario buttonLabel="Editar" itemId={itemId} item={item} updateState={props.updateState} contra={contra}></EditarUsuario> </>}
                </div>
            </>
        )
    })
