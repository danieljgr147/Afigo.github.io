    ...
    return (
        <><Nav />
            <section class="flex flex-row w-full h-full" >
                ...
                <section class="mt-[2rem] flex flex-col">
                    <div class="w-full flex flex-col pl-[7rem] h-[30vh]">
                        <h1 class="font-bold text-4xl py-4">Bienvenido! Daniel</h1>
                        <p class="py-2 font-bold">Nombre: Daniel Josue Gonzalez Rodriguez</p>
                        <p class="py-2 font-bold">Usuario: danijgr</p>
                        <p class="py-2 font-bold">Sucursal: Palmares</p>
                    </div>

                    <div class=" pl-[7rem] pt-[2rem] w-[100vw] border-b-[4px] border-navy flex flex-row">
                        <div class="bg-navy rounded-t-xl">
                            <h2 class="text-white font-semibold px-4 py-2 text-xl">Acciones</h2>
                        </div>
                    </div>

                    <div class="pl-[5rem] pt-[3rem]">
                        <div class="flex p-[2rem] flex-col bg-baby rounded-xl shadow-xl w-2/5">
                            <div class="mb-[1.5rem]">
                            ...
                            <div class="flex content-center items-center overflow-x-auto overflow-y-auto w-[90%]  shadow-xl sm:rounded-xl">
